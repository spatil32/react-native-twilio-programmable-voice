...
import static com.hoxfon.react.RNTwilioVoice.Constants.ACTION_CANCEL_CALL_INVITE;
...
import static com.hoxfon.react.RNTwilioVoice.Constants.CANCELLED_CALL_INVITE_ERR;
...
//     */
//    private void sendCancelledCallInviteToActivity(@NonNull CancelledCallInvite cancelledCallInvite, @Nullable CallException callException) {
//        SoundPoolManager.getInstance((this)).stopRinging();
//        Intent intent = new Intent(ACTION_CANCEL_CALL_INVITE);
//        intent.putExtra(CANCELLED_CALL_INVITE, cancelledCallInvite);
//        if (callException != null) {
//            intent.putExtra(CANCELLED_CALL_INVITE_ERR, callException.toString());
//        }
//        LocalBroadcastManager.getInstance(this).sendBroadcast(intent);
//    }
}
